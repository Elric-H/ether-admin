 ...
 */
package com.xuan.gen.modular.basic.service.impl;
...
import com.xuan.common.util.CommonDownloadUtil;
import com.xuan.common.util.CommonResponseUtil;
import com.xuan.dbs.api.DbsApi;
import com.xuan.gen.core.util.GenDbTypeUtil;
import com.xuan.gen.modular.basic.entity.GenBasic;
import com.xuan.gen.modular.basic.enums.GenDbsIdEnum;
import com.xuan.gen.modular.basic.enums.GenEffectTypeEnum;
import com.xuan.gen.modular.basic.enums.GenYesNoEnum;
import com.xuan.gen.modular.basic.mapper.GenBasicMapper;
import com.xuan.gen.modular.basic.param.*;
import com.xuan.gen.modular.basic.result.*;
import com.xuan.gen.modular.basic.service.GenBasicService;
import com.xuan.gen.modular.config.entity.GenConfig;
import com.xuan.gen.modular.config.param.GenConfigAddParam;
import com.xuan.gen.modular.config.service.GenConfigService;
import com.xuan.mobile.api.MobileModuleApi;
import com.xuan.sys.api.SysButtonApi;
import com.xuan.sys.api.SysMenuApi;
import com.xuan.sys.api.SysRoleApi;
...
public class GenBasicServiceImpl extends ServiceImpl<GenBasicMapper, GenBasic> implements GenBasicService {
    ...
    public GenBasic add(GenBasicAddParam genBasicAddParam) {
        ...
        this.save(genBasic);
        addGenConfig(genBasic, genBasicAddParam.getDbsId());
        return genBasic;
    }
    ...
    public GenBasic edit(GenBasicEditParam genBasicEditParam) {
        ...
        if (!genBasic.getDbTable().equals(genBasicEditParam.getDbTable())) {
            ...
            // 新增新表的数据字段
            addGenConfig(genBasic, genBasicEditParam.getDbsId());
        }
     ...
     */
    private void addGenConfig (GenBasic genBasic, String dbsId) {
    ...
    public JSONObject getBindingJsonObject(GenBasic genBasic) {
        ...
        // 是否使用动态字段
        bindingJsonObject.set("dfcWhether",genBasic.getDfcWhether());
        // 定义配置详情列表

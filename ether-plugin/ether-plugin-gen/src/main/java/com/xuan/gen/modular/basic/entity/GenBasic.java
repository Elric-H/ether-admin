 ...
 */
package com.xuan.gen.modular.basic.entity;
...
public class GenBasic extends CommonEntity {
    ...
    /** 移动端所属模块 */
    @ApiModelProperty(value = "移动端所属模块", position = 13)
    @TableField(insertStrategy = FieldStrategy.IGNORED, updateStrategy = FieldStrategy.IGNORED)
    private String mobileModule;

    /** 功能名 */
    @ApiModelProperty(value = "功能名", position = 14)
    private String functionName;

    /** 业务名 */
    @ApiModelProperty(value = "业务名", position = 15)
    private String busName;

    /** 类名 */
    @ApiModelProperty(value = "类名", position = 16)
    private String className;

    /** 表单布局 */
    @ApiModelProperty(value = "表单布局", position = 17)
    private String formLayout;

    /** 使用栅格 */
    @ApiModelProperty(value = "使用栅格", position = 18)
    ...
    /** 作者 */
    @ApiModelProperty(value = "作者", position = 21)
    private String authorName;

    /** 使用动态字段 */
    @ApiModelProperty(value = "使用动态字段", position = 22)

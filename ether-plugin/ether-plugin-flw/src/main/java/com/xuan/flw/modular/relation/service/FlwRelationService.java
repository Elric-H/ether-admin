 ...
 */
package com.xuan.flw.modular.relation.service;
...
public interface FlwRelationService extends IService<FlwRelation> {
     ...
     */
    List<FlwRelation> getRelationListByObjectId(String objectId);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByObjectIdList(List<String> objectIdList);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByObjectIdAndCategory(String objectId, String category);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByObjectIdListAndCategory(List<String> objectIdList, String category);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByTargetId(String targetId);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByTargetIdList(List<String> targetIdList);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByTargetIdAndCategory(String targetId, String category);
     ...
     * @date 2022/4/27 22:06
     */
    List<FlwRelation> getRelationListByTargetIdListAndCategory(List<String> targetIdList, String category);

 ...
 */
package com.xuan.flw.modular.template.entity;
...
public class FlwTemplateSn extends CommonEntity {
    ...
    /** 前缀 */
    @ApiModelProperty(value = "前缀", position = 5)
    private String prefix;

    /** 年月格式 */
    @ApiModelProperty(value = "年月格式", position = 6)
    private String dateFormat;

    /** 后缀位数 */
    @ApiModelProperty(value = "后缀位数", position = 7)
    private Integer suffixDigits;

    /** 后缀初始值 */
    @ApiModelProperty(value = "后缀初始值", position = 8)
    private Integer suffixInitialValue;

    /** 后缀增量 */
    @ApiModelProperty(value = "后缀增量", position = 9)
    private Integer suffixIncrementalValue;

    /** 显示值 */
    @ApiModelProperty(value = "显示值", position = 10)
    private String previewValue;

    /** 最新值 */
    @ApiModelProperty(value = "最新值", position = 11)

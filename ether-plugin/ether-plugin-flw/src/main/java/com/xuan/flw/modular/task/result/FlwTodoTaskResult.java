 ...
 */
package com.xuan.flw.modular.task.result;
...
public class FlwTodoTaskResult {
    ...
    /** 当前节点id */
    @ApiModelProperty(value = "当前节点id", position = 8)
    private String currentActivityId;

    /** 当前节点名称 */
    @ApiModelProperty(value = "当前节点名称", position = 9)
    private String currentActivityName;

    /** 办理人（顿号分割） */
    @ApiModelProperty(value = "办理人（顿号分割）", position = 10)

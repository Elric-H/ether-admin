 ...
 */
package com.xuan.sys.modular.user.controller;
...
import com.xuan.sys.modular.user.result.SysUserMessageDetailResult;
import com.xuan.sys.modular.user.result.SysUserMessageResult;
import com.xuan.sys.modular.user.result.SysUserPicValidCodeResult;
import com.xuan.sys.modular.user.result.SysUserPositionResult;
...
public class SysUserCenterController {
    ...
    @ApiOperation("根据id获取头像")
    @PostMapping("/sys/userCenter/getAvatarById")
    public CommonResult<String> getAvatarById(@RequestBody @Valid SysUserIdParam sysUserIdParam) {

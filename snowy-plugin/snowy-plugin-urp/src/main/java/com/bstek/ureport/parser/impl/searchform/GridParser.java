...
public class GridParser implements FormParser<GridComponent> {
    ...
    public GridComponent parse(Element element) {
        ...
        grid.setShowBorder(Boolean.parseBoolean(element.attributeValue("show-border")));
        if (grid.isShowBorder()) {
            grid.setBorderColor(element.attributeValue("border-color"));
            grid.setBorderWidth(Integer.parseInt(element.attributeValue("border-width")));
        }
        ...
        for (Object obj : element.elements()) {
            ...
            cols.add(col);
            col.setSize(Integer.parseInt(ele.attributeValue("size")));

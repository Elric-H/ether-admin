...
public class CommonEntity implements Serializable, TransPojo {
    ...
    @TableField(fill = FieldFill.INSERT)
    @Trans(type = TransType.RPC, targetClassName = "com.xuan.sys.modular.user.entity.SysUser", fields = "name", alias = "createUser", ref = "createUserName")
    ...
    @TableField(fill = FieldFill.UPDATE)
    @Trans(type = TransType.RPC, targetClassName = "com.xuan.sys.modular.user.entity.SysUser", fields = "name", alias = "updateUser", ref = "updateUserName")

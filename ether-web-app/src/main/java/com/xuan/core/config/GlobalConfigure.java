...
import com.xuan.common.annotation.CommonNoRepeat;
import com.xuan.common.annotation.CommonWrapper;
import com.xuan.common.cache.CommonCacheOperator;
import com.xuan.common.enums.CommonDeleteFlagEnum;
import com.xuan.common.exception.CommonException;
import com.xuan.common.listener.CommonDataChangeEventCenter;
import com.xuan.common.listener.CommonDataChangeListener;
import com.xuan.common.pojo.CommonResult;
import com.xuan.common.pojo.CommonWrapperInterface;
import com.xuan.common.util.CommonTimeFormatUtil;
import com.xuan.core.handler.GlobalExceptionUtil;
 ...
 **/
@Configuration
@MapperScan(basePackages = {"com.xuan.**.mapper, com.bstek.**.mapper"})
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public static class CommonWrapperAop {
         ...
         */
        @Pointcut("@annotation(com.xuan.common.annotation.CommonWrapper)")
